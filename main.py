...
#points = ut.so_newton_sg(wrap(function), start)
# params ===
...
print('function:  ', calc_count - 2 * ut.der_count + 6 * ut.hess_count)
print('derivative:', ut.der_count - 2 * ut.grad_count - 9 * ut.hess_count)
